...
export function RadioSelector({setradioindex}) {
    return (
        <div>
            <div className='w-full  h-14 bg-black flex items-center hover:bg-neutral-900'
            ...
            <div onClick={() => setradioindex(1)}
                 className='w-full  h-14 bg-black flex items-center hover:bg-neutral-600'>
            ...
            <div onClick={() => setradioindex(2)}
                 className='w-full select-none h-14 bg-black flex items-center hover:bg-neutral-600'
            >
